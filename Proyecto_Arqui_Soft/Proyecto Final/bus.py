    ...
    while True:
        ...
        if data[5:10] == 'sinit':
            ...
            if service_code == 'login':
                ...
                index = 2
            elif service_code == 'lista':
                index = 3
            elif service_code == 'vemaz':
                index = 4
            elif service_code == 'crema':
                index = 5
            elif service_code == 'creus':
                index = 6
            elif service_code == 'edcol':
                index = 7
            elif service_code == 'edmaz':
                index = 8
            elif service_code == 'elmaz':
                index = 9
            elif service_code == 'elcar':
                index = 10
            elif service_code == 'eluse':
                index = 11
...
def handle_connection(client_socket,data,address):
    ...
    while True:
        ...
        if index is not None and service_auth[index] is not None:
            ...
            client_socket.send(f"00017{service_code}NK".encode())
